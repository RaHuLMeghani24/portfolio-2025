...
/**
 * TechIconCardExperience renders a 3D model inside a react-three-fiber Canvas with lighting, environment, and interactive controls.
 * It optionally customizes the material of a specific mesh for the "Interactive Developer" model.
 *
 * @component
 * @param {Object} props
 * @param {Object} props.model - The model configuration object.
 * @param {string} props.model.modelPath - The path to the GLTF model file.
 * @param {string} props.model.name - The name of the model, used for conditional logic.
 * @param {Array<number>} props.model.scale - The scale to apply to the model [x, y, z].
 * @param {Array<number>} props.model.rotation - The rotation to apply to the model [x, y, z] in radians.
 * @returns {JSX.Element} The rendered 3D model experience card.
 */
